...
-- From Omarchy (MIT, omacom/omarchy quattro: default/hypr/helpers.lua), verbatim.
-- Provides o.bind / o.window / o.exec_on_start used by the defaults below.
-- Arch-only launchers (omarchy-launch-*, pacman helpers) are NOT ported yet;
-- Fedora rewrites for bin/omarchy-* live in system_files/usr/local/bin.
