-- Utility bindings: menus, shell panels, capture, toggles (Fedora scope).
-- Adapted from Omarchy default/hypr/bindings/utilities.lua (MIT).
-- Dropped per spec/scope: reminders, transcode, weather, agent, voxtype,
-- tmux/herdr pickers, music/Docker/Signal/Obsidian/webapp binds.
-- Kept: shell menus + panels, lock, screenshots/OCR, keybindings help,
-- calculator (omacalc from whelanh/omarchy COPR), notifications, zoom.
