-- Wayland environment for Hyprland Lua.
-- From Omarchy (MIT, omacom/omarchy quattro: default/hypr/envs.lua), verbatim.
-- No Archisms here: pure Wayland/cursor/portals env, portable to Fedora.
...
require_optional.module("default.hypr.nvidia")
