-- Hyprland bootstrap for Omarchy-Fedora's Lua module path.
-- Ported from Omarchy (MIT, omacom/omarchy quattro: default/hypr/bootstrap.lua).
...
-- Omarchy-Fedora defaults from $OMARCHY_PATH.
package.path = home
  .. "/.local/state/?.lua;"
  .. home
  .. "/.config/?.lua;"
  .. (os.getenv("OMARCHY_PATH") or "/usr/share/omarchy-fedora")
  .. "/?.lua;"
  .. package.path
